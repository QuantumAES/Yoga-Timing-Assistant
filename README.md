...
плотностях, монохромный слой для тематических иконок, знак в интерфейсе,
картинка 512×512 для Play и цвет подложки:
...
| `:feature:stats` | статистика занятий: период, сводка, график, календарь месяца |
