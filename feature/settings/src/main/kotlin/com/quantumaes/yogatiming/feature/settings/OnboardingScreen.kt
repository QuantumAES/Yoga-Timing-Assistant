 ...
 * гарантию закончить вовремя; таймер, который идёт всегда. Порядок — от того,
 * что придётся сделать первым, к тому, ради чего это всё.
 *
 * Обещания сформулированы утвердительно (замечание 2 полевой проверки
 * 2026-08-05): «отсчёт не прервётся» сначала называет поломку и только потом
 * её отрицает — на первом экране это лишний такт чтения.
 *
